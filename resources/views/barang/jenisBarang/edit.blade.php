...
<section class="section">
    ...
    <div class="row">
        <form method="POST" action="{{ route('jenisBarangUpdate', $jenis_barangs->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate="" style="width: 100%;display: flex;flex-wrap:wrap;">
            @csrf
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="jenis_barang" required="" value="{{ $jenis_barangs->jenis_barang }}">
