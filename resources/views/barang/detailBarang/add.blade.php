...
<section class="section">
    ...
    <div class="row">
        <form method="POST" action="{{ route('detailBarangSave') }}" enctype="multipart/form-data" class="needs-validation" novalidate="" style="width: 100%;display: flex;flex-wrap:wrap;">
            @csrf
