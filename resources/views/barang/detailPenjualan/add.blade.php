...
<section class="section">
    ...
    <div class="row">
        <form method="POST" action="{{ route('detailPenjualanSave') }}" enctype="multipart/form-data" class="needs-validation" novalidate="" style="width: 100%;display: flex;flex-wrap:wrap;">
            @csrf
            ...
            <div class="col-12 col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h4>Tambah Detail Penjualan Masuk</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
